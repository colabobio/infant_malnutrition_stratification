...
recoded_vars <- append(recoded_vars, "dd_quintile")
```
...
```{r}
# This is not being added for some reason....
...
```{r}
path <- "data/DHS-2019-21/"
dffile <- "recoded-variables.txt"
write.table(recoded_vars, here(path, dffile), row.names = FALSE, col.names = FALSE)
```
